...
FILEstrip is to be run while MITM (Man In The Middle). 
...
This trojan file is created by editing the line 'NAME' within trojan_filestrip so that it can open the correct
